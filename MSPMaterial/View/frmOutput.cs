...
namespace MSPMaterial.View
{
    public partial class frmOutput : Form
    {
        ...
        {
            var outputResult = db.getOutputlist("", "");
            outputlistBindingSource.DataSource = outputResult;
        }

        private void frmOutput_Leave(object sender, EventArgs e)
        {
            db.closeConnection();
        }
        ...
        private void txtID_TextChanged(object sender, EventArgs e)
        {
            ...
            picOutput.Image = cf.getImage(type, id);
        }
        ...
        private void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    var result = db.getOutputlist(cbxItem.SelectedItem.ToString(), txtSearchValue.Text);
                    ...
                    {
                        outputlistBindingSource.DataSource = result;
                    }
                }
            }
        }
